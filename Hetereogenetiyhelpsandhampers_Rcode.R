...
prehandling.data <- read_dta("G:/Nuffield DPhil/Experiment paper 2/stata/Data/paper2_21102019.dta")
...
setwd("G:/Nuffield DPhil/Experiment paper 2/Rstudio/Data")
...
Modelb <- lme(fixed = Appropriation ~ Klee, random = ~1|groupid/subjectid, data = working.data)
summary(Model4)
